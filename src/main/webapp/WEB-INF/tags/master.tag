            ...
            <div class="container">
              ...
              <div class="menu" role="navigation">
                  ...
                  <li class="c-nav__item c-nav__item--icon">
                    <a title="Cadastrar" class="c-nav__link dropdown-toggle">Cadastrar
                    <svg><use xlink:href="<c:url value="/resources/svg/svg/symbols.svg#arrow-option"/>"></svg>
                  </a>
                  <div class="c-nav__dropdown">
                    <a class="c-nav__dropdown-item" href="<c:url value="cadastrar/pesquisador-clinico"/>" title="Pesquisador Clínico">Pesquisador Clínico</a>
                    <a class="c-nav__dropdown-item" href="<c:url value="cadastrar/laboratorio-clinico"/>" title="Laboratório Clínico">Laboratório Clínico</a>
                  </div>
                </li>
                  <li class="c-nav__item c-nav__item--icon">
